...
export default function ContactCard() {
  ...
  return (
    <section
      className="relative bg-[#000000] text-[#F5F5F5] font-inter py-24 px-6 flex items-center justify-center overflow-hidden"
      id="contact"
    >
      <div
        data-aos="fade-up"
        ...
        >
          ...
          >
            <div>
              ...
              <p className="text-[#CCCCCC] text-base">Head Auto Electrician</p>
            </div>
            ...
            <div
              data-aos="fade-up"
              data-aos-delay="400"
              className="flex justify-center md:justify-start gap-5 pt-4"
            >
              <motion.a
