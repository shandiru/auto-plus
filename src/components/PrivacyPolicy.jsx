            ...
            <div className="mt-8 space-y-6">
                ...
                <section>
                    ...
                    <div className="text-white">
                        <p><strong>autoplusnottingham</strong></p>
                        <p>Email: <a href="mailto:Info@autoplusnottingham.co.uk" className="text-[#E30613] hover:underline">Info@autoplusnottingham.co.uk</a></p>
                        <p>Phone: 44 7495159438</p>
